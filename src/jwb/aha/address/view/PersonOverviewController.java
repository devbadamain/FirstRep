...
import jwb.aha.address.MainApp;
...
public class PersonOverviewController {
	...
	private void handleDeletePerson() {
		...
		//추가와 변경 다이얼로그
		//추가와 변경과 같은 동작은 할 일이 조금 더 있습니다: 연락처 정보를 묻는 
		//양식의 커스텀 다이얼로그 (이 말은 새로운 스테이지)가 필요합니다.
		//새로운 fxml 파일인 PersonEditDialog.fxml을 view 패키지에 만듭니다.
